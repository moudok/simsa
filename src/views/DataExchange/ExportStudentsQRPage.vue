  ...
  <ion-page>
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>{{ t('exchange.exportStudents') }}</ion-title>
      </ion-toolbar>
    </ion-header>
    ...
    <ion-content class="ion-padding">
      <div class="qr-container">
        ...
        <p v-else-if="noStudents">{{ t('session.noStudents') }}</p>
        <p v-else>...</p>
...
import type { QRPayload, StudentsPayload } from '@/types'
